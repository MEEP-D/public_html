...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'quizzes'], function () {
            ...
            Route::get('/{id}/results/exce', 'QuizController@resultsExportExcel');
            Route::get('/result/{result_id}/ldelete', 'QuizController@resultDelete');
            Route::get('/excel', 'QuizController@exportExcel');
            Route::post('/{id}/order-items', 'QuizController@orderItems');
            Route::post('/import', 'QuizController@import')->name('admin.quizzes.import');
            Route::get('/{id}/create_quiz_form', 'QuizController@questions')->name('adminQuizCreateForm');
            Route::put('/questions/{id}', 'QuizController@updateQuestion')->name('adminUpdateQuestion');
        });

        Route::group(['prefix' => 'quizzes-questions'], function () {
            Route::post('/store', 'QuizQuestionController@store');
            Route::get('/{id}/edit', 'QuizQuestionController@edit')->name('adminEditQuizQuestion');
